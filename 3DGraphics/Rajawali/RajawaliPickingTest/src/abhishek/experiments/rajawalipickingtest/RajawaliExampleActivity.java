...
public class RajawaliExampleActivity extends RajawaliFragmentActivity
{
    ...
    public static String LOG_TAG = "RajawaliObjectPickingTest";
    ...
    public void showLoader()
    {
        mLayout.post(new Runnable()
        {
            public void run()
            {
                ...
                RotateAnimation anim1 = new RotateAnimation(360, 0, Animation.RELATIVE_TO_SELF, .5f,
    ...
    public void hideLoader()
    {
        mLayout.post(new Runnable()
        {
            public void run()
            {
                ...
                ((AnimationSet) mLoaderGraphic.getAnimation()).addAnimation(anim);
            }
        });
    }
}
